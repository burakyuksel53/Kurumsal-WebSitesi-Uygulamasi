    ...
    public class HizmetController : Controller
    {
        ...
        public ActionResult Edit(int? id, Hizmet hizmet, HttpPostedFileBase ResimURL)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (ResimURL != null)
                {
                    if (System.IO.File.Exists(Server.MapPath(h.ResimURL))) // Daha önce kaydedilmiş resim var mı kontrol et.
                    {
                        System.IO.File.Delete(Server.MapPath(h.ResimURL)); // Daha önce kaydedilmiş resim varsa sil.
                    }
                    ...
                    img.Resize(500, 500);
                    img.Save("~/Upload/Hizmet/" + hizmetname);

                    h.ResimURL = "/Upload/Hizmet/" + hizmetname;
                }
