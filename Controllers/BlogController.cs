...
namespace KurumsalWeb1.Controllers
{
    public class BlogController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.Blog.Include("Kategori").ToList().OrderBy(x => x.BlogId));
        }

        public ActionResult Create()
        {
            ViewBag.KategoriId = new SelectList(db.Kategori, "KategoriId", "KategoriAd"); // Kategori tablosundan kategori isimlerini çekmek için.
            return View();
        }
        ...
        public ActionResult Create(Blog blog, HttpPostedFileBase ResimURL)
        {
            if (ResimURL != null)
            {
                ...
                img.Resize(600, 400);
                img.Save("~/Upload/Blog/" + blogimgname);
